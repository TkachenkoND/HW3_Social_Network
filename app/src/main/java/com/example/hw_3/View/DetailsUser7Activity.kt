...
class DetailsUser7Activity : AppCompatActivity() {

    private lateinit var vm: UserViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.details_activity_user7)
        ...
        vm.userLiveData.observe(this, Observer {
            ...
            detailsUserName.text = it.userList[6].name
            detailsTextStatus.text = it.userList[6].status
            detailsTitle.text = it.userList[6].aboutMe
            Glide.with(this)
