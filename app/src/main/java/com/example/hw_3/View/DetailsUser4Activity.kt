...
class DetailsUser4Activity : AppCompatActivity() {

    private lateinit var vm: UserViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.details_activity_user4)
        ...
        vm.userLiveData.observe(this, Observer {
            ...
            detailsUserName.text = it.userList[3].name
            detailsTextStatus.text = it.userList[3].status
            detailsTitle.text = it.userList[3].aboutMe
            Glide.with(this)
