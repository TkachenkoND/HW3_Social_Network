...
class DetailsUser6Activity : AppCompatActivity() {

    private lateinit var vm: UserViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.details_activity_user6)
        ...
        vm.userLiveData.observe(this, Observer {
            ...
            detailsUserName.text = it.userList[5].name
            detailsTextStatus.text = it.userList[5].status
            detailsTitle.text = it.userList[5].aboutMe
            Glide.with(this)
