...
class DetailsUser5Activity : AppCompatActivity() {

    private lateinit var vm: UserViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.details_activity_user5)
        ...
        vm.userLiveData.observe(this, Observer {
            ...
            detailsUserName.text = it.userList[4].name
            detailsTextStatus.text = it.userList[4].status
            detailsTitle.text = it.userList[4].aboutMe
            Glide.with(this)
