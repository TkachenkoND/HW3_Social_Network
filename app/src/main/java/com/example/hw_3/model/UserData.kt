...
class UserData {
    ...
    init {
        ...
        userList.add(User(0, "Julia", "5 min ago",
        ...
        userList.add(User(3, "Ida", "Yesterday",
        ...
        userList.add(User(4, "William", "45 min ago",
        ...
        userList.add(User(5, "Harry", "Yesterday",
        ...
        userList.add(User(6, "Angelina", "2 hours ago",
